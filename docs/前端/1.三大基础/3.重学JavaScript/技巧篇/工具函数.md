...
![1634232772779-fcc7123d-1f81-402e-8192-a617c333d23a.png](./img/xN5pVNbbN8fHK_Px/1634232772779-fcc7123d-1f81-402e-8192-a617c333d23a-701485.png)
...
#### （4）<font style="color:rgb(18, 18, 18);">骆驼命名转换成短横线命名</font>
```javascript
...
#### （5）<font style="color:rgb(18, 18, 18);">短横线命名转换成骆驼命名</font>
```javascript
...
#### （7）<font style="color:rgb(51, 51, 51);">半角转换为全角</font>
```javascript
...
#### （4）校验<font style="color:rgb(33, 37, 41);">是否为IPv6地址</font>
```javascript
...
### 9. 设备判断
#### （1）判断是<font style="color:rgb(79, 79, 79);">移动还是PC设备</font>
```javascript
...
> 更新: 2021-10-19 21:53:44  
> 原文: <https://www.yuque.com/cuggz/feplus/ftuzhp>