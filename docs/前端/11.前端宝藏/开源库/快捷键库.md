...
![1683273219821-598cb1ca-e491-4629-9027-f6152ca09b4f.png](./img/cNbI5f_zB3q_r8t3/1683273219821-598cb1ca-e491-4629-9027-f6152ca09b4f-086591.png)
...
2. 在需要使用Tinykeys的JavaScript文件中，通过import语句导入Tinykeys库：
...
2. 在需要使用useHotkeys的React函数组件中，通过import语句导入useHotkeys库：

```javascript
import { useHotkeys } from 'react-hotkeys-hook';
```

3. 在组件内部调用useHotkeys() Hook方法来设置键盘快捷键的响应函数及相关配置：
...
![1683274909572-50dd323e-3737-4218-ad93-5779b426ac6e.png](./img/cNbI5f_zB3q_r8t3/1683274909572-50dd323e-3737-4218-ad93-5779b426ac6e-481893.png)

### Cmdk

<font style="color:rgb(36, 41, 47);background-color:rgb(244, 246, 248);">⌘K是一个灵活的React组件，可以用于创建命令菜单或可访问的组合框。它支持自定义API，可以通过组合其他组件或静态JSX来实现个性化需求。</font>

![1683274816609-c6f92b61-7aa5-402f-be64-5f92bdd478e0.png](./img/cNbI5f_zB3q_r8t3/1683274816609-c6f92b61-7aa5-402f-be64-5f92bdd478e0-232951.png)
...
Ninja Keys<font style="color:rgb(36, 41, 47);background-color:rgb(244, 246, 248);"> 是一个可以集成到网站中的键盘快捷键 UI 组件，支持使用纯 JavaScript、Vue 和 React 来创建自定义的快捷键。在许多应用中，用户会按下 ⌘+k（或 ctrl+k） 打开搜索 UI 界面，Ninja Keys 类似于这一模式。</font>

![1683275490029-a11f3d84-1af3-4bb5-8761-41a190669a10.gif](./img/cNbI5f_zB3q_r8t3/1683275490029-a11f3d84-1af3-4bb5-8761-41a190669a10-387932.gif)
...
> 更新: 2023-05-30 15:03:57  
> 原文: <https://www.yuque.com/cuggz/feplus/gg7v1ha3q6kanhfk>