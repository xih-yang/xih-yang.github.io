...
![1635264820723-512b345c-9715-4891-a57a-890e588998f2.png](./img/IqEknEBGRFPhpiRm/1635264820723-512b345c-9715-4891-a57a-890e588998f2-855335.png)
...
* 名称的长度必须小于或等于214个字符，不能以“.”和“\_”开头，不能包含大写字母（这是因为当软件包在npm上发布时，会基于此属性获得自己的URL，所以不能包含非URL安全字符（<font style="color:rgb(34, 34, 34);">non-url-safe</font>））；
* 名称可以作为参数被传入require("")，用来导入模块，所以应当尽可能的简短、语义化；
* 名称不能和其他模块的名称重复，可以使用npm view命令查询模块明是否重复，如果重复就会提示404：

![1635175636076-33595e1a-d8d6-4aa8-ab2f-18f02b30ca4b.png](./img/IqEknEBGRFPhpiRm/1635175636076-33595e1a-d8d6-4aa8-ab2f-18f02b30ca4b-938082.png)

如果npm包上有对应的包，则会显示包的详细信息：

![1635175578663-64bf5cb9-4d7c-4114-8d38-19af0f9d1cab.png](./img/IqEknEBGRFPhpiRm/1635175578663-64bf5cb9-4d7c-4114-8d38-19af0f9d1cab-453883.png)
...
![1635177200796-ffd50c7a-0e95-4099-aa57-fa4b1bab7984.png](./img/IqEknEBGRFPhpiRm/1635177200796-ffd50c7a-0e95-4099-aa57-fa4b1bab7984-186439.png)
...
![1635181515396-fe760662-7ac8-4389-ba11-3784b572021a.png](./img/IqEknEBGRFPhpiRm/1635181515396-fe760662-7ac8-4389-ba11-3784b572021a-178678.png)
...
dependencies字段中声明的是项目的生产环境中所必须的依赖包。当使用<font style="color:rgb(44, 52, 55);"> npm 或 yarn 安装npm包时，该npm包会被自动插入到此配置项中：</font>
...
<font style="color:rgb(44, 52, 55);">当使用 npm 或 yarn 安装软件包时，指定以下参数后，新安装的npm包会被自动插入到此列表中：</font>
...
<font style="color:rgb(44, 52, 55);">这些脚本是命令行应用程序。可以通过调用 </font>npm run XXX<font style="color:rgb(44, 52, 55);"> 或 </font>yarn XXX<font style="color:rgb(44, 52, 55);"> 来运行它们，其中 </font>XXX<font style="color:rgb(44, 52, 55);"> 是命令的名称。 例如：</font>npm run dev<font style="color:rgb(44, 52, 55);">。我们可以为命令使用任何的名称，脚本也可以是任何操作。</font>
...
上面的配置在package.json包中国提供了一个映射到本地文件名的bin字段，之后npm包将链接这个文件到prefix/fix里面，以便全局引入。或者链接到本地的node\_modules/.bin/文件中，以便在本项目中使用。
...
### 6. <font style="color:rgb(18, 18, 18);">license</font>
...
package.json<font style="color:rgb(44, 52, 55);"> 文件还可以承载命令特有的配置，例如 Babel、ESLint 等。它们每个都有特有的属性，例如 </font>eslintConfig<font style="color:rgb(44, 52, 55);">、</font>babel<font style="color:rgb(44, 52, 55);"> 等。 它们是命令特有的，可以在相应的命令/项目文档中找到如何使用它们。下面来看几个常用的第三方配置项。</font>
...
eslint的配置可以写在单独的配置文件<font style="color:rgb(64, 64, 64);">.eslintrc.json </font>中，也可以写在package.json文件的eslintConfig配置项中。
...
### <font style="color:rgb(44, 52, 55);">7. browserslist</font>
...
> 更新: 2022-08-11 18:13:39  
> 原文: <https://www.yuque.com/cuggz/feplus/rkiyxe>