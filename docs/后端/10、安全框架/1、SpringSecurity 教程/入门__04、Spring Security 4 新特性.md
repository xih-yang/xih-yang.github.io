...
- 来源：https://ddkk.com/zhuanlan/security/springsecurity/1/4.html
- 分类：安全框架
- 分组：入门
...
- 很多集成测试添加到示例中
- 弃用[@EnableWebMvcSecurity](https://github.com/EnableWebMvcSecurity) - 通过更新最小Spring版本，我们现在默认使用[@EnableWebSecurity](https://github.com/EnableWebSecurity) 和MVC集成，仍然允许它被覆盖。
