# 14、Shiro RememberMe
- 来源：https://ddkk.com/zhuanlan/security/shiro/1/14.html
- 分类：安全框架
- 分组：教程目录
## RememberMe
...
设置securityManager 安全管理器的 rememberMeManager；
...
**1、** 访问http://localhost:8080/chapter13/，会跳转到登录页面，登录成功后会设置会话及rememberMeCookie；
...
因此RememberMe 使用过程中，需要配合相应的拦截器来实现相应的功能，用错了拦截器可能就不能满足你的需求了。
