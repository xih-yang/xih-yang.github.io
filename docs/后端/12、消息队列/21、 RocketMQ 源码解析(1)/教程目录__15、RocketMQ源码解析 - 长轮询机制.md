...
- 来源：https://ddkk.com/zhuanlan/mq/rocketmq/1/15.html
- 分类：消息队列
- 分组：教程目录
## 1、长轮询、短轮询概述
...
## 3、源码解析PullRequestHoldService线程
...
## 4、源码解析DefaultMessageStore#ReputMessageService
...
从run 方法可以看出 ReputMessageService 线程是一个“拼命三郎”，每执行完一次业务方法 doReput，休息1毫秒，就继续抢占CPU，再次执行 doReput 方法。
