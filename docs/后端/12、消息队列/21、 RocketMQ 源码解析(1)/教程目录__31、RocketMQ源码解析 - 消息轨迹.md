...
- 来源：https://ddkk.com/zhuanlan/mq/rocketmq/1/31.html
- 分类：消息队列
- 分组：教程目录
...
- ArrayBlockingQueue`` traceContextQueue

消息轨迹TraceContext队列，用来存放待发送到服务端的消息。
- ArrayBlockingQueue`` appenderQueue
...
#### 1.2.2 源码解析SendMessageTraceHookImpl
