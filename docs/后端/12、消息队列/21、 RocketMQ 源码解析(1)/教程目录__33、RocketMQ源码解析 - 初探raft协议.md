...
- 来源：https://ddkk.com/zhuanlan/mq/rocketmq/1/33.html
- 分类：消息队列
- 分组：教程目录
...
> 温馨提示：上述结论只是我的一些思考，我们可以带着上述思考，进入到Dleger的学习中，下一篇将从源码解析的角度来学习大神是如何实现Raft协议的Leader选主的，让我们一起期待吧。
...
**1、** 如果Leader节点向从节点广播日志时，其中某个从节点发送故障宕机，该如何处理呢？；
...
我相信读者朋友肯定还有更多的疑问，本文不打算来回答上述疑问，而是带着这些问题进入到RocketMQ多副本的学习中，通过源码解析RocketMQ DLedger的实现后，再来重新总结raft协议。
