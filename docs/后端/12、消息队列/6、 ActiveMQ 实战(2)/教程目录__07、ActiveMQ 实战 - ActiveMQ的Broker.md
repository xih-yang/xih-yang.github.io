...
- 来源：https://ddkk.com/zhuanlan/mq/activemq/2/7.html
- 分类：消息队列
- 分组：教程目录
### 是什么？
...
在连接linux服务器上ActiveMQ的基础上，把连接到linux服务器的ip地址改成本机地址即可。参考：[5.Java编码实现ActiveMQ通讯（Topic）](/zhuanlan/mq/activemq/2/5.html)
