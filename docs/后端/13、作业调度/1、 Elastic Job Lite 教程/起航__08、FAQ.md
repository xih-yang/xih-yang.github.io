# 08、FAQ
- 来源：https://ddkk.com/zhuanlan/job/elasticjoblite/8.html
- 分类：作业调度
- 分组：起航
## 1. 阅读源码时为什么会出现编译错误?
...
elastic-job-lite-spring的jar包中`META-INF\spring.schemas`配置了xsd文件的位置：[http://www.dangdang.com/schema/ddframe/reg/reg.xsd=META-INF/namespace/reg.xsd](http://www.dangdang.com/schema/ddframe/reg/reg.xsd=META-INF/namespace/reg.xsd)[http://www.dangdang.com/schema/ddframe/job/job.xsd=META-INF/namespace/job.xsd，需确保jar包中该文件存在。](http://www.dangdang.com/schema/ddframe/job/job.xsd=META-INF/namespace/job.xsd，需确保jar包中该文件存在。)
