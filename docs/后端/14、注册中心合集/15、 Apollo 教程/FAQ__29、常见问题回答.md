# 29、常见问题回答
- 来源：https://ddkk.com/zhuanlan/config/apollo/29.html
- 分类：配置中心
- 分组：FAQ
## 1. Apollo是什么？
...
Apollo是支持的。请参考Apollo使用指南中的`三、集群独立配置说明`

## 6. 我有多个应用需要使用同一份配置，Apollo是否能支持？

Apollo是支持的。请参考Apollo使用指南中的`四、多个AppId使用同一份配置`
...
由于我们自己并非Disconf的资深用户，所以无法主观地给出评价。 不过之前Apollo技术支持群中的热心网友[@Krast](https://github.com/krast)做了一个[开源配置中心对比矩阵](https://github.com/apolloconfig/apollo/files/983064/default.pdf)，可以参考一下。
