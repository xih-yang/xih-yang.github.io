# 26、Apollo开放平台接入指南
- 来源：https://ddkk.com/zhuanlan/config/apollo/26.html
- 分类：配置中心
- 分组：使用文档
## 1、 什么是开放平台？
...
Apollo管理员在 [http://{portal_address}/open/manage.html](http://{portal_address}/open/manage.html) 创建第三方应用，创建之前最好先查询此AppId是否已经创建。创建成功之后会生成一个token，如下图所示：

## 2.2 给已注册的第三方应用授权

第三方应用不应该能操作任何Namespace的配置，所以需要给token绑定可以操作的Namespace。Apollo管理员在 [http://{portal_address}/open/manage.html](http://{portal_address}/open/manage.html) 页面给token赋权。赋权之后，第三方应用就可以通过Apollo提供的Http REST接口来管理已授权的Namespace的配置了。
...
.Net core也提供了open api的客户端，详见[https://github.com/ctripcorp/apollo.net/pull/77](https://github.com/ctripcorp/apollo.net/pull/77)
...
- 全部和openapi有关的shell脚本在文件夹 [https://github.com/apolloconfig/apollo/tree/master/scripts/sql](https://github.com/apolloconfig/apollo/tree/master/scripts/sql) 下
...
- **URL** : [http://{portal_address}/openapi/v1/apps/{appId}/envclusters](http://{portal_address}/openapi/v1/apps/{appId}/envclusters)
- **Method** : GET
- **Request Params** : 无
- **返回值Sample**：
...
- **URL** : [http://{portal_address}/openapi/v1/apps](http://{portal_address}/openapi/v1/apps)
- **Method** : GET
- **Request Params** :
...
- **URL** ： [http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}](http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName})
- **Method** ： GET
- **Request Params** ：无
- **返回值Sample**：
...
- **URL** ： [http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters](http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters)
- **Method** ： POST
- **Request Params** ：无
...
- **URL** : [http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces](http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces)
- **Method**: GET
- **Request Params**: 无
- **返回值Sample**:
...
- **URL** ： [http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}](http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName})
- **Method** ： GET
- **Request Params** ：无
- **返回值Sample** ：
...
- **URL** ： [http://{portal_address}/openapi/v1/apps/{appId}/appnamespaces](http://{portal_address}/openapi/v1/apps/{appId}/appnamespaces)
- **Method** ： POST
- **Request Params** ：无
- **请求内容(Request Body, JSON格式)** ：
...
- **URL** ： [http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/lock](http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/lock)
- **Method** ： GET
- **Request Params** ：无
- **返回值 Sample（未锁定）** ：
...
- **URL** ： [http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/items/{key}](http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/items/{key})
- **Method** ： GET
- **Request Params** ：无
- **返回值Sample** ：
...
- **URL** ： [http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/items](http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/items)
- **Method** ： POST
- **Request Params** ：无
- **请求内容(Request Body, JSON格式)** ：
...
true
String
配置的key，需和url中的key值一致。非properties格式，key固定为content
...
true
String
item的修改人，格式为域账号，也就是sso系统的User ID
...
- **URL** ： [http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/items/{key}?operator={operator}](http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/items/{key}?operator={operator})
- **Method** ： DELETE
- **Request Params** ：
...
true
String
配置的key。非properties格式，key固定为content
...
- **URL** ： [http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/releases](http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/releases)
- **Method** ： POST
- **Request Params** ：无
- **Request Body** ：
...
true
String
发布人，域账号，注意：如果ApolloConfigDB.ServerConfig中的namespace.lock.switch设置为true的话（默认是false），那么该环境不允许发布人和编辑人为同一人。所以如果编辑人是zhanglea，发布人就不能再是zhanglea。
...
- **URL** ： [http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/releases/latest](http://{portal_address}/openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/releases/latest)
- **Method** ： GET
- **Request Params** ：无
- **返回值Sample** ：
...
- **URL** ： [http://{portal_address}/openapi/v1/envs/{env}/releases/{releaseId}/rollback](http://{portal_address}/openapi/v1/envs/{env}/releases/{releaseId}/rollback)
- **Method** ： PUT
- **Request Params** ：
