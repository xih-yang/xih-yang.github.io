# 16、Portal接入邮件服务
- 来源：https://ddkk.com/zhuanlan/config/apollo/16.html
- 分类：配置中心
- 分组：开发文档
...
**2、** 在ApolloPortalDB.ServerConfig表配置以下参数，也可以通过管理员工具-系统参数页面进行配置，修改完一分钟实时生效如下：
