# 15、Portal实现用户登录功能
- 来源：https://ddkk.com/zhuanlan/config/apollo/15.html
- 分类：配置中心
- 分组：开发文档
...
- OpenID Connect 的提供者配置端点(符合 RFC 8414 标准的 issuer-uri), 需要是 **https** 的, 例如 [https://host:port/auth/realms/apollo/.well-known/openid-configuration](https://host:port/auth/realms/apollo/.well-known/openid-configuration)
