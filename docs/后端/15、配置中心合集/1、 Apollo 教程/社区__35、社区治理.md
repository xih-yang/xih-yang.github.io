# 35、社区治理
- 来源：https://ddkk.com/zhuanlan/config/apollo/35.html
- 分类：配置中心
- 分组：社区
## Overview
...
Youare also encouraged to participate in the projects in the following ways:
...
ACommitter must have accomplished one or more of the following items:
...
ThePMC(Project Management Committee) functions as the core management team that oversees the Apollo community. The PMC has additional responsibilities over and above those of Committers. These responsibilities ensure the smooth running of the project.
