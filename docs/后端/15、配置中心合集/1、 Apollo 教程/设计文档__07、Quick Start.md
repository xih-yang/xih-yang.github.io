# 07、Quick Start
- 来源：https://ddkk.com/zhuanlan/config/apollo/7.html
- 分类：配置中心
- 分组：设计文档
...
> 注：Quick Start需要有bash环境，Windows用户请安装Git Bash，建议使用最新版本，老版本可能会遇到未知问题。也可以直接通过IDE环境启动，详见Apollo开发指南。
...
**2、** 在根目录下执行`mvncleanpackage-plapollo-assembly-am-DskipTests=true`；
...
**1、** 点击SampleApp进入配置界面，可以看到当前有一个配置timeout=100![ ][nbsp2]；
...
**1、** 在配置界面点击timeout这一项的编辑按钮![ ][nbsp3]；

**2、** 在弹出框中把值改成200并提交![ ][nbsp4]；

**3、** 点击发布按钮，并填写发布信息![ ][nbsp5]；
