...
- 来源：https://ddkk.com/zhuanlan/config/disconf/15.html
- 分类：配置中心
- 分组：客户端
## 12.1. 目的

当通过java bean 进行控制配置时，当某个配置有初始化或更新时，可以在 bean property setter 方法里 做适合自己的业务逻辑。
