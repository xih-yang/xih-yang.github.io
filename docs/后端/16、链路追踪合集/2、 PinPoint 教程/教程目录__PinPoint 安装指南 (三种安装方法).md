...
- 来源：https://ddkk.com/zhuanlan/linktrack/pinpoint/1.html
- 分类：链路追踪
- 分组：教程目录
...
[http://10.39.43.117:8079/](http://10.39.43.117:8079/)
...
访问[http://10.39.43.117:28080/(nodeIP:28080)](http://10.39.43.117:28080/%28nodeIP:28080%29)
...
访问[http://10.39.43.117:28081/(nodeIP:28081)](http://10.39.43.117:28081/%28nodeIP:28081%29)
...
这一步比较慢，可略过，直接下载[releases](https://github.com/naver/pinpoint/releases/latest)
...
配置相关说明请参考[pinpoint-collector](http://naver.github.io/pinpoint/installation.html#3-pinpoint-collector)
...
相关的配置文件在`WEB-INF/classes/`下,定义参考[web-configuration](http://naver.github.io/pinpoint/installation.html#configuration-1)

部署mysql数据库(告警要用到)参考[alarm-implementation](http://naver.github.io/pinpoint/alarm.html#2-implementation--configuration)
...
然后[mysql密码修改](https://blog.csdn.net/evandeng2009/article/details/50999706)

之后导入相关的表[CreateTableStatement-mysql.sql SpringBatchJobRepositorySchema-mysql.sql](https://github.com/naver/pinpoint/tree/master/web/src/main/resources/sql)
...
这时候我们可以访问一下这个地址，在浏览器中输入”[http://nodeIP:28080](http://nodeIP:28080)“，就会出现主页面了

配置pp-agent采集器

相关说明请参考[Pinpoint Agent](http://naver.github.io/pinpoint/installation.html#installation-2)

这个需要用户在服务启动时添加上这个三行就可以了，是不是很酷

`-javaagent:$AGENT_PATH/pinpoint-bootstrap-$VERSION.jar`pinpoint-bootstrap-VERSION的位置
...
请参考[flink](http://naver.github.io/pinpoint/applicationinspector.html#1-introduction)

## 5、打镜像

参考[docker 安装pinpoint](https://blog.csdn.net/qq_21816375/article/details/74898709)
