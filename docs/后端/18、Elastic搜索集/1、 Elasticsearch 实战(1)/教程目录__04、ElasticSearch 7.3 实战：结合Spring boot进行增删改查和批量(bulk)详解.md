...
- 来源：https://ddkk.com/zhuanlan/search/elasticsearch/1/4.html
- 分类：搜索引擎
- 分组：教程目录
**1、** 前置；

java api 文档 [https://www.elastic.co/guide/en/elasticsearch/client/java-rest/7.3/java-rest-overview.html](https://www.elastic.co/guide/en/elasticsearch/client/java-rest/7.3/java-rest-overview.html)。low : 偏向底层。high：高级封装。
...
config:
  elasticsearch:
    hostlist: 127.0.0.1:9200多个节点用逗号分隔
```
