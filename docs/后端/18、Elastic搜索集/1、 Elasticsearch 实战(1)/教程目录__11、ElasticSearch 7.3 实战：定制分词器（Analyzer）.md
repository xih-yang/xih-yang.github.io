...
- 来源：https://ddkk.com/zhuanlan/search/elasticsearch/1/11.html
- 分类：搜索引擎
- 分组：教程目录
### 1、默认的分词器

关于分词器，前面的博客已经有介绍了，链接：[ElasticSearch7.3 学习之倒排索引揭秘及初识分词器(Analyzer)](/zhuanlan/search/elasticsearch/1/8.html)。这里就只介绍默认的分词器standard analyzer
