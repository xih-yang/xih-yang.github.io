...
- 来源：https://ddkk.com/zhuanlan/search/elasticsearch/1/13.html
- 分类：搜索引擎
- 分组：教程目录
## 1、dynamic mapping
...
[boolean](https://www.elastic.co/guide/en/elasticsearch/reference/7.10/boolean.html) field

boolean

floating point number

[float](https://www.elastic.co/guide/en/elasticsearch/reference/7.10/number.html) field

double

integer

[long](https://www.elastic.co/guide/en/elasticsearch/reference/7.10/number.html) field

long

object

[object](https://www.elastic.co/guide/en/elasticsearch/reference/7.10/object.html) field
...
Either a [date](https://www.elastic.co/guide/en/elasticsearch/reference/7.10/date.html) field (if the value passes [date detection](https://www.elastic.co/guide/en/elasticsearch/reference/7.10/dynamic-field-mapping.html#date-detection)), a [double](https://www.elastic.co/guide/en/elasticsearch/reference/7.10/number.html) or [long](https://www.elastic.co/guide/en/elasticsearch/reference/7.10/number.html) field (if the value passes [numeric detection](https://www.elastic.co/guide/en/elasticsearch/reference/7.10/dynamic-field-mapping.html#numeric-detection)) or a [text](https://www.elastic.co/guide/en/elasticsearch/reference/7.10/text.html) field, with a [keyword](https://www.elastic.co/guide/en/elasticsearch/reference/7.10/keyword.html) sub-field.
