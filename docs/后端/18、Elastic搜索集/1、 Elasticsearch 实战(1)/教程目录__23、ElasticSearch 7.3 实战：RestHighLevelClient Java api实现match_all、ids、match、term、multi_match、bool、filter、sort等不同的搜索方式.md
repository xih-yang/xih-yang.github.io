...
- 来源：https://ddkk.com/zhuanlan/search/elasticsearch/1/23.html
- 分类：搜索引擎
- 分组：教程目录
## 1、数据准备
...
**2、** 在上面的学习过程中，应该也能发现规律，Java代码中构建搜索请求与rest风格的语法及其类似，包括其搜索方式、代码层级所以在实际应用中，要先在kibana中完善搜索代码，只要kibana中能够搜索出来，Java代码一般来说也能行，这样能够缩短代码调试的时间；
