...
- 来源：https://ddkk.com/zhuanlan/search/elasticsearch/1/25.html
- 分类：搜索引擎
- 分组：教程目录
## 1、Doc value
...
关于文档的查询过程，前面博客已经解析过了：[ElasticSearch7.3学习(六)----文档（document）内部机制详解](/zhuanlan/search/elasticsearch/1/6.html)
