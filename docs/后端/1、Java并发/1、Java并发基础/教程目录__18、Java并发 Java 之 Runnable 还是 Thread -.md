...
- 来源：https://ddkk.com/zhuanlan/java/concurrency/1/18.html
- 分类：Java并发
- 分组：教程目录
...
我们也可以把这个 SimpleThread 放到前面章节 [一文秒懂 Java ExecutorService](https://ddkk.com/c/penglei/javatm/javatm-basic-executorservice.html) 中提到的 ExecutorService 中运行。
