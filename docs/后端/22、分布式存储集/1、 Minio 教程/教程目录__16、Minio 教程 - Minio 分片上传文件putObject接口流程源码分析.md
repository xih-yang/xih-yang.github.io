# 16、Minio 教程 - Minio 分片上传文件putObject接口流程源码分析
- 来源：https://ddkk.com/zhuanlan/filestorage/minio/1/16.html
- 分类：分布式存储
- 分组：教程目录
### 前言
...
基于[Java 客户端 API](https://docs.min.io/docs/java-client-api-reference.html)
