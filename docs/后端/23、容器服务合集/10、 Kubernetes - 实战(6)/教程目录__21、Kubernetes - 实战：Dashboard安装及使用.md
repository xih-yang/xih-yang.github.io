...
- 来源：https://ddkk.com/zhuanlan/container/kubernetes/6/21.html
- 分类：容器服务
- 分组：教程目录
## Helm安装Dashboard
...
> 注意：前提是已经安装好helm工具，如未安装还可请参考本人其他随笔：/zhuanlan/container/kubernetes/6/20.html
...
发现Pod 状态为 **ImagePullBackOff** ，因为镜像的原因，查看下所需镜像：
...
注意：如果是使用base64加过密的，要记得输入解密后的token哦
...
> 将cluster-admin 的权限赋予给名称为 k8s-dashboard-kubernetes-dashboard 的 SA，cluster-admin是集群默认的的角色，具有整个集群的所有权限，如果有个性化需求，自己定义一个ClusterRole也是可以的
...
使用域名访问：[https://hub.vfancloud.com:31087](https://hub.vfancloud.com:31087)
