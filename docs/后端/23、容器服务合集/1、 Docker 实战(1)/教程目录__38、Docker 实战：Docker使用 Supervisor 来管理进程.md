...
- 来源：https://ddkk.com/zhuanlan/container/docker/1/38.html
- 分类：容器服务
- 分组：教程目录
...
添加supervisord 的配置文件，并复制配置文件到对应目录下面。
...
使用docker run 来启动我们创建的容器。使用多个 -p 来映射多个端口，这样我们就能同时访问 ssh 和 apache 服务了。
