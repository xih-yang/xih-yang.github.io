...
- 来源：https://ddkk.com/zhuanlan/container/docker/1/77.html
- 分类：容器服务
- 分组：教程目录
## CentOS
...
[CentOS](https://en.wikipedia.org/wiki/CentOS) 是流行的 Linux 发行版，其软件包大多跟 RedHat 系列保持一致。 该仓库提供了 CentOS 从 5 ~ 7 各个版本的镜像。
