...
- 来源：https://ddkk.com/zhuanlan/container/docker/2/12.html
- 分类：容器服务
- 分组：教程目录
...
那些STATUS 栏以 Exited 开头的都是已经退出停止了的容器

我们可以使用下面的命令删除容器 6801e4604a32

```sh
[root@ddkk.com ~]# docker rm 6801e4604a32
6801e4604a32
```
...
```sh
[root@ddkk.com ~]# docker rm e66458d65564
...
更多docker rm 命令使用方法，可以访问 docker rm 命令
