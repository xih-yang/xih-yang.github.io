...
- 来源：https://ddkk.com/zhuanlan/container/kubernetes/3/27.html
- 分类：容器服务
- 分组：教程目录
## 前言 安全认证
...
ApiServer是访问及管理对象资源的唯一入口，任何一个请求访问ApiServer，都要经过下面三个流程：
...
kubernetes集群安全的最关键点是在于如何识别认证客户端身份，它提供了3种客户端身份认证方式；
...
3) 设置集群、用户、上下文信息
[root@master pki]# kubectl config set-cluster kubernetes --embed-certs=true --certificate-authority=/etc/kubernetes/pki/ca.crt --server=https://192.168.88.100:6443
...
[root@master pki]# kubectl config use-context devman@kubernetes
Switched to context "devman@kubernetes".
# 查看,发现此时可以查看到dev下面的pods,表明devman有权限
[root@master pki]# kubectl get pods -n dev
NAME                                 READY   STATUS    RESTARTS   AGE
nginx-deployment-6696798b78-dm77v    1/1     Running   0          31h
nginx-deployment-6696798b78-ht9px    1/1     Running   0          31h
nginx-deployment-6696798b78-vhtr9    1/1     Running   0          31h
pod-configmap                        1/1     Running   0          142m
pod-secret                           1/1     Running   0          113m
tomcat-deployment-58467d5474-4nb76   1/1     Running   0          31h
tomcat-deployment-58467d5474-8vwgp   1/1     Running   0          31h
tomcat-deployment-58467d5474-frvgm   1/1     Running   0          31h
volume-emptydir                      2/2     Running   0          28h
