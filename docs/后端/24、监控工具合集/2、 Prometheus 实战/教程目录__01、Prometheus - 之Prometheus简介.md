# 01、Prometheus - 之Prometheus简介
- 来源：https://ddkk.com/zhuanlan/monitoring/prometheus/1.html
- 分类：监控工具
- 分组：教程目录
## 0.前言

本文来自Prometheus官网手册https://prometheus.io/docs/introduction/overview/#overview和Prometheus简介https://prometheus.fuckcloudnative.io/。
