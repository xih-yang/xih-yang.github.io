# 07、Transaction报表
- 来源：https://ddkk.com/zhuanlan/linktrack/cat/7.html
- 分类：链路追踪
- 分组：报表简介
## Transaction报表
...
**4、****机器分组**CAT可以将若干个机器，作为一个分组进行数据统计默认会有一个All分组，代表所有机器的统计数据，即集群统计数据；
...
**6、****单个Type指标图表**点击show，查看Type所有name分钟级统计，如下图:![ ][nbsp1]![ ][nbsp2]；
