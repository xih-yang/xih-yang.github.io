# 10、Heartbeat报表
- 来源：https://ddkk.com/zhuanlan/linktrack/cat/10.html
- 分类：链路追踪
- 分组：报表简介
## Heartbeat报表
...
**5、****指标分组**心跳指标分组，比如系统指标（SystemInfo）、GC指标（GCInfo）、JVM指标（JVMHeapInfo）等；
...
NewGc Count / PS Scavenge Count
新生代GC次数

NewGc Time / PS Scavenge Time
新生代GC耗时
