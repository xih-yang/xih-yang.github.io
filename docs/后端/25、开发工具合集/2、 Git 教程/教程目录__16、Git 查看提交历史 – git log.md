...
- 来源：https://ddkk.com/zhuanlan/tools/git/16.html
- 分类：开发工具
- 分组：教程目录
在使用Git 提交了若干更新之后，又或者克隆了某个项目，想回顾下提交历史，我们可以使用 git log 命令查看。
...
Author: penglei penglei@souyunku.cn
...
更多git log 命令可查看： [http://git-scm.com/docs/git-log](http://git-scm.com/docs/git-log)
