# 07、Maven 插件
- 来源：https://ddkk.com/zhuanlan/tools/maven/7.html
- 分类：开发工具
- 分组：教程目录
## Maven – 插件
...
我们已经在我们的例子中大量使用了 **maven-antrun-plugin** 来输出数据到控制台上。请查看 [Maven – 构建配置文件](https://www.w3cschool.cn/maven/tchv1ht8.html) 章节。让我们用一种更好的方式理解这部分内容，在 C:\MVN\project 目录下创建一个 pom.xml 文件。
