# 08、Maven 创建工程
- 来源：https://ddkk.com/zhuanlan/tools/maven/8.html
- 分类：开发工具
- 分组：教程目录
## Maven – 创建工程
...
打开C:\MVN\consumerBanking\src\test\java\com\companyname\bank 文件夹，可以看到 AppTest.java。
...
在下个章节中，我们将讨论如何使用 maven 构建和测试工程：[Maven – 构建 & 测试工程](https://www.w3cschool.cn/maven/cpuw1htg.html)。
