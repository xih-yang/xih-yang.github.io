# 14、Maven 构建自动化
- 来源：https://ddkk.com/zhuanlan/tools/maven/14.html
- 分类：开发工具
- 分组：教程目录
## Maven – 构建自动化
...
一旦bus-core-api 构建成功，Maven 将会自动开始构建 app-web-ui 项目， 日志如下：
...
等到app-web-ui 创建成功，Maven 接着开始构建 app-desktop-ui 工程，日志输出如下：
