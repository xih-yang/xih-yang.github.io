# 06、Gradle Java 构建入门
- 来源：https://ddkk.com/zhuanlan/tools/gradle/6.html
- 分类：开发工具
- 分组：教程目录
## Java 构建入门
...
执行gradle uploadArchives 以发布 jar 包。
...
执行gradle eclipse 来生成 Eclipse 项目文件。
...
本章中，我们了解了如何构建一个基本 Java 工程。但这都是一小部分基础，用 Gradle 还可以做很多事。关于 了解更多可参阅 [Java 插件](https://www.w3cschool.cn/gradle/5vdr1hug.html)，The Java Plugin，并且你可以在 Gradle 发行包中的 samples/java 目录找到更多例子。

另外，不要忘了继续阅读[依赖管理基础内容](https://www.w3cschool.cn/gradle/sh8k1htf.html)
