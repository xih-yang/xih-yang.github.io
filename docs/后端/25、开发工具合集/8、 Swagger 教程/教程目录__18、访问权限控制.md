# 18、访问权限控制
- 来源：https://ddkk.com/zhuanlan/tools/swagger/18.html
- 分类：开发工具
- 分组：教程目录
,通常有时候我们碰到的问题如下：
...
/doc.html
SwaggerBootstrapUi提供的文档访问地址

/api-docs-ext
SwaggerBootstrapUi提供的增强接口地址
...
不过在1.9.0版本时,针对Swagger的资源接口,SwaggerBootstrapUi提供了简单的**Basic认证功能**
