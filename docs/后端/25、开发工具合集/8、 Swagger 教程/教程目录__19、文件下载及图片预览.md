# 19、文件下载及图片预览
- 来源：https://ddkk.com/zhuanlan/tools/swagger/19.html
- 分类：开发工具
- 分组：教程目录
类型
说明
...
SwaggerBootstrapUi在1.8.9版本中添加了application/octet-stream下载类型的支持,并在1.9.0版本中完善,只需要配置相应接口的produces,即可在doc.html页面中查看效果，如下图：
