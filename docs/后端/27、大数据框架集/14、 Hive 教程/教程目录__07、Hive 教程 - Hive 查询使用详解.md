# 07、Hive 教程 - Hive 查询使用详解
- 来源：https://ddkk.com/zhuanlan/bigdata/hive/2/7.html
- 分类：大数据框架
- 分组：教程目录
## 查询语句语法
...
例如，**table**总**bucket**数为**4**，tablesample(bucket 1 out of 2)，表示总共抽取（4/2=）2个bucket的数据，抽取第1(x)个和第3(x y)个bucket的数据。
