# 16、JDBC - 教程 - JDBC PrepareStatement对象执行批量处理实例
- 来源：https://ddkk.com/zhuanlan/db/jdbc/3/16.html
- 分类：缓存数据库
- 分组：教程目录
...
以下代码片段提供了使用`PrepareStatement`对象的批量更新示例，将下面代码保存到文件：*BatchingWithPrepareStatement.java* -
