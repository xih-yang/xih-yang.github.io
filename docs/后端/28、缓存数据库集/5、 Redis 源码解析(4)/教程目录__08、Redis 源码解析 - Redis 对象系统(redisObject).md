# 08、Redis 源码解析 - Redis 对象系统(redisObject)
- 来源：https://ddkk.com/zhuanlan/db/redis/4/8.html
- 分类：缓存数据库
- 分组：教程目录
## Redis 对象系统
...
- [双端链表源码剖析和注释](/zhuanlan/db/redis/4/1.html)
- [简单动态字符串(SDS)源码剖析和注释](/zhuanlan/db/redis/4/2.html)
- [字典结构源码剖析和注释](/zhuanlan/db/redis/4/3.html)
- [跳跃表源码剖析和注释](/zhuanlan/db/redis/4/4.html)
- [整数集合源码剖析和注释](/zhuanlan/db/redis/4/5.html)
- [压缩列表源码剖析和注释](/zhuanlan/db/redis/4/6.html)
- [快速列表源码剖析和注释](/zhuanlan/db/redis/4/7.html)
