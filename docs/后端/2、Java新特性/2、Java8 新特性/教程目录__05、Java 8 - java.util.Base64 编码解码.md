...
- 来源：https://ddkk.com/zhuanlan/java/java8/5.html
- 分类：Java 8 新特性
- 分组：教程目录
...
该类实现使用 RFC 4648 和 RFC 2045 中规定的 Base64 解码方案解码数据

static class Base64.Encoder
该类实现使用 RFC 4648 和 RFC 2045 中规定的 Base64 编码方案编码数据
   ...
   public static void main(String args[]) {
      try {
         String base64encodedString = Base64.getEncoder().encodeToString(
            "Java 8 Base64 编码解码 - Java8新特性 - DDKK.COM 弟弟快看，程序员编程资料站 ".getBytes("utf-8"));
...
```java
[penglei@www.ddkk.com helloworld]$ javac Base64Tester.java  && java Base64Tester
SmF2YSA4IEJhc2U2NCDnvJbnoIHop6PnoIEgLSBKYXZhOOaWsOeJueaApyAtIOeugOWNleaVmeeoiyA=
Java 8 Base64 编码解码 - Java8新特性 - DDKK.COM 弟弟快看，程序员编程资料站
```
