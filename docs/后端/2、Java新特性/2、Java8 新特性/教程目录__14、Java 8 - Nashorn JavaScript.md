...
- 来源：https://ddkk.com/zhuanlan/java/java8/14.html
- 分类：Java 8 新特性
- 分组：教程目录
...
```java
print('你好，DDKK.COM 弟弟快看，程序员编程资料站，教程 ！');
```
...
```java
[penglei@www.ddkk.com helloworld]$ jjs hello.js
你好，DDKK.COM 弟弟快看，程序员编程资料站，教程 ！
```
...
```java
[penglei@www.ddkk.com helloworld]$ jjs
jjs> 
```
...
```java
jjs> print('你好，DDKK.COM 弟弟快看，程序员编程资料站，教程 ！');
你好，DDKK.COM 弟弟快看，程序员编程资料站，教程 ！
jjs> 5 + 8
13
jjs> 8 / 5
...
```java
[penglei@www.ddkk.com helloworld]$ jjs -- 你好 DDKK.COM 弟弟快看，程序员编程资料站 教程 
jjs> print('你输入的是: ' +arguments.join(", "))
你输入的是: 你好, DDKK.COM 弟弟快看，程序员编程资料站, 教程 
jjs> 
```
...
public class Java8Tester {
   public static void main(String args[]) {
      ScriptEngineManager scriptEngineManager = new ScriptEngineManager();
      ScriptEngine nashorn = scriptEngineManager.getEngineByName("nashorn");
      String name = "DDKK.COM 弟弟快看，程序员编程资料站";
      Integer result = null;
      try {
...
如果在JavaScript 中调用 Java 代码，我们就不做过多介绍了，因为介绍起来是一个庞大的工程，简直就是另外一门语言的赶脚。
