...
- 来源：https://ddkk.com/zhuanlan/java/java8/15.html
- 分类：Java 8 新特性
- 分组：教程目录
...
**3、** 在时区方面，新的日期时间API引入了**域**(domain)这个概念；
...
当前日期时间: 2022-05-08T21:47:12.488370
```
...
```java
[penglei@www.ddkk.com helloworld]$ javac Java8Tester.java && java Java8Tester
当前日期时间: 2022-05-08T21:50:23.181839
当前日期: 2022-05-08
...
```java
[penglei@www.ddkk.com helloworld]$ javac Java8Tester.java && java Java8Tester
当前日期时间: 2022-05-08T21:54:40.534997
当前月份: OCTOBER
当前月中的第几天: 8
当前秒数: 40
```
...
```java
[penglei@www.ddkk.com helloworld]$ javac Java8Tester.java && java Java8Tester
当前日期时间: 2022-05-08T21:58:14.011932
新的日期时间: 2012-10-10T21:58:14.011932
原来的日期时间: 2022-05-08T21:58:14.011932
```
