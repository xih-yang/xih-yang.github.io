# Java 8 并发教程：同步和锁
- 来源：https://ddkk.com/zhuanlan/java/java8new/5.html
- 分类：Java新特性
- 分组：教程目录
...
在[上一章](/zhuanlan/java/java8new/4.html)中，我们学到了如何通过执行器服务同时执行代码。当我们编写这种多线程代码时，我们需要特别注意共享可变变量的并发访问。假设我们打算增加某个可被多个线程同时访问的整数。
