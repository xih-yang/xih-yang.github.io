# 04、Python 教程 - 字符串
- 来源：https://ddkk.com/zhuanlan/other/python/1/4.html
- 分类：Python 教程
- 分组：教程目录
## 1 简介

在之前的文章【[Python 教程 - 入门必备知识](/zhuanlan/other/python/1/1.html)】中我们已经提到了：字符串是 Python 的一种数据类型，它可以通过单引号 `'`、双引号 `"`、三引号 `'''` 或 `"""` 来定义，本节我们来详细介绍一下。
