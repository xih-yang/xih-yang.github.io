# 15、Python 教程 - 枚举
- 来源：https://ddkk.com/zhuanlan/other/python/1/15.html
- 分类：Python 教程
- 分组：教程目录
## 1 简介

起初Python 中并未内置枚举（enum）类型，枚举是在 Python3.4 添加的新功能，此时我们可能会有一个疑问：Python3.4 之前的版本还能不能使用枚举呢？
...
枚举语法与 class 语法相同，之前我们在[Python 教程 - 面向对象](/zhuanlan/other/python/1/11.html)中已经介绍过 class 了，枚举的定义可以通过继承 Enum 的方式来实现， 看一下示例：
