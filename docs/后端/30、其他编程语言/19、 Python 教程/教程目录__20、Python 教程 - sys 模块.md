# 20、Python 教程 - sys 模块
- 来源：https://ddkk.com/zhuanlan/other/python/1/20.html
- 分类：Python 教程
- 分组：教程目录
## 1. 简介

sys模块主要负责与 Python 解释器进行交互，该模块提供了一系列用于控制 Python 运行环境的函数和变量。

之前我们说过 [os 模块](/zhuanlan/other/python/1/13.html)，该模块与 sys 模块从名称上看着好像有点类似，实际上它们之间是没有什么关系的，os 模块主要负责与操作系统进行交互。
