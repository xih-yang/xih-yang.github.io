# 13、Python 教程 - Python元组
- 来源：https://ddkk.com/zhuanlan/other/python/4/13.html
- 分类：Python 入门实战
- 分组：教程目录
## 1 元组（Tuple）

元组是有序且不可更改的集合。在 Python 中，元组是用**圆括号**编写的。
...
如需创建仅包含一个元素的元组，您**必须在该元素后添加一个逗号**，否则 Python 无法将变量识别为元组。
