# 19、Python 教程 - 函数
- 来源：https://ddkk.com/zhuanlan/other/python/4/19.html
- 分类：Python 入门实战
- 分组：教程目录
## 1 Python 函数
...
def my_function(fname):
    print(fname + " Gates")
my_function("Bill")     "Bill  Gates" 
my_function("Steve")     "Steve Gates"
my_function("Elon")      "Elon Gates"
```
...
my_function("India")    I am from Sweden India
my_function()     I am from Sweden China
my_function("Brazil")    I am from Sweden Brazil
```
...
在Python 文档中，“关键字参数”一词通常简称为 `kwargs`。
...
my_function("Phoebe", "Jennifer", "Rory")    The youngest child is Rory
```

## 10 pass 语句

函数定义不能为空，但是如果出于某种原因写了无内容的函数定义，请使用 pass 语句来避免错误。
