# 18、Python 教程 - 数据结构
- 来源：https://ddkk.com/zhuanlan/other/python/5/18.html
- 分类：Python 快速上手
- 分组：教程目录
### 列表
...
使用del 语句可以从一个列表中根据索引来删除一个元素，而不是值来删除元素。这与使用 pop() 返回一个值不同。可以用 del 语句从列表中删除一个切割，或清空整个列表（我们以前介绍的方法是给该切割赋一个空列表）。例如：
