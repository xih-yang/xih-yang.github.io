# 33、Python 教程 - MongoDB
- 来源：https://ddkk.com/zhuanlan/other/python/5/33.html
- 分类：Python 快速上手
- 分组：教程目录
### MongoDB
...
旧版的Python 可以使用 easy_install 来安装，easy_install 也是 Python 包管理工具。
