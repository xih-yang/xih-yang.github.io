# 01、Python 进阶 - 多线程
- 来源：https://ddkk.com/zhuanlan/other/python/2/1.html
- 分类：Python 进阶
- 分组：教程目录
## 1. 相关概念
...
GIL全称 global interpreter lock，中文译为全局解释器锁，CPython 解释器就是通过 GIL 机制来确保同一时刻只有一个线程执行 Python 代码的，这样做十分方便的帮助 CPython 解决了并发访问的线程安全问题，但却牺牲了在多处理器上的并行性，所以 CPython 解释器下的多线程并不是真正意义上的多线程。
