# 15、Python 爬虫 - PyQuery 框架
- 来源：https://ddkk.com/zhuanlan/other/python/2/15.html
- 分类：Python 进阶
- 分组：教程目录
PyQuery 是仿照 jQuery 实现的，语法与 jQuery 几乎完全相同，如果你熟悉 jQuery，又不想再记一套 BeautifulSoup （[Python 爬虫（三）：BeautifulSoup 库](/zhuanlan/other/python/2/13.html)） 的调用方法，那么 PyQuery 是一个很好的选择。
