# 15、Ruby 运算符
- 来源：https://ddkk.com/zhuanlan/other/ruby/15.html
- 分类：Ruby 教程
- 分组：教程目录
...
2.4.0 :001 > foo = 33
 => 33 
2.4.0 :002 > defined? foo
 => "local-variable" 
2.4.0 :003 > defined? $_
 => "global-variable" 
2.4.0 :004 > defined? bar
 => nil 
2.4.0 :005 >
```
...
```ruby
2.4.0 :008 > defined? puts      # puts 是一个方法
 => "method" 
2.4.0 :006 > defined? puts(bar) # 未定义
 => nil 
2.4.0 :007 > defined? unpack   # 未定义
 => nil 
```
