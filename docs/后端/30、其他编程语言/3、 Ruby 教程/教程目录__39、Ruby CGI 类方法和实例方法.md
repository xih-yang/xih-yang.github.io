...
- 来源：https://ddkk.com/zhuanlan/other/ruby/39.html
- 分类：Ruby 教程
- 分组：教程目录
Ruby 的 CGI 类提供了大量的类方法和实例方法，方便我们创建 CGI 程序
...
1
CGI::new([level="query"])
创建 CGI 对象。query可以是以下值:query:没有 HTML 生成输出html3:HTML3.2html4:HTML4.0 Stricthtml4Tr:HTML4.0 Transitionalhtml4Fr:HTML4.0 Frameset
...
返回整齐的HTML格式
如果指定了leader，它将写入到每一行的开头。leader默认值为两个空格

10
CGI::rfc1123_date(time)
根据 RFC-1123 来格式化时间 (例如, Tue, 2 Jun 2018 00:00:00 GMT)

### CGI 实例方法

下表列出了 CGI::new 的对象的所有方法

我们假设 c 是 CGI:new 的实例
...
Ruby 语言 CGI 模块可以使用相应的 HTML 标签名方法来创建 HTML 标签
