# 22、Perl 正则表达式
- 来源：https://ddkk.com/zhuanlan/other/perl/22.html
- 分类：Perl 教程
- 分组：教程目录
...
=cut
$bar = "I am www.ddkk.com site. welcome to www.ddkk.com site.";
if ($bar =~ /tw/){
   print "第一次匹配\n";
}else{
   print "第一次不匹配\n";
...
=pod
  ...
  Copyright © 2015-2065 www.ddkk.com. All rights reserved.
=cut
$string = "welcome to www.ddkk.com site.";
$string =~ m/ddkk/;
print "匹配前的字符串: $\n";
print "匹配的字符串: $&\n";
print "匹配后的字符串: $'\n";
...
下面的范例中将 "google" 替换为 "www.ddkk.com"
...
下面的范例将变量 `$` string 中的所有小写字母转化为大写字母
...
```sh
$ perl main.pl
WELCOME TO WWW.TWLE.CN SITE.
```

下面的范例使用 /s 将变量 `$` string 重复的字符删除
