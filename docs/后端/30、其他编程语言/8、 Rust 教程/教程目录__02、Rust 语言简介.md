# 02、Rust 语言简介
- 来源：https://ddkk.com/zhuanlan/other/rust/2.html
- 分类：Rust 教程
- 分组：教程目录
Rust 是一门系统级别的编程语言。
...
估计我们能说出一大堆理由来，然而，对我来说，最大的理由就是 [字节跳动公司的飞聊团队已经用上了 Rust 语言了](/t/646#reply0)。这意味着学好 Rust 语言就有机会找到高薪的工作。
...
WebAssembly (WASM) 语言是被设计用来在浏览器端/嵌入式设别上运行的，用于执行 CPU 计算密集型的语言。
