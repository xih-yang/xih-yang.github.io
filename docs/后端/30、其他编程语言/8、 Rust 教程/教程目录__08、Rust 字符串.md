# 08、Rust 字符串
- 来源：https://ddkk.com/zhuanlan/other/rust/8.html
- 分类：Rust 教程
- 分组：教程目录
Rust 语言提供了两种字符串
...
```sh
let name1 = "你好，DDKK.COM 弟弟快看，程序员编程资料站 DDKK.COM 弟弟快看，程序员编程资料站";
```
...
```sh
fn main() {
   let company:&str="DDKK.COM 弟弟快看，程序员编程资料站";
   let location:&str = "中国";
...
```sh
fn main() {
   let company:&'static str = "DDKK.COM 弟弟快看，程序员编程资料站";
...
```sh
公司名 : DDKK.COM 弟弟快看，程序员编程资料站 位于 :中国
```
...
fn main(){
   ...
   let content_string = String::from("DDKK.COM 弟弟快看，程序员编程资料站");
...
Theabove example creates two strings − an empty string object using the *new* method and a string object from string literal using the *from* method.
...
replace()
pub fn replace(&'a self, from: P, to: &str) -> String
搜索指定模式并替换
...
split()
pub fn split(&'a self, pat: P) -> Split
...
fn main(){
   ...
   z.push_str("DDKK.COM 弟弟快看，程序员编程资料站 DDKK.COM 弟弟快看，程序员编程资料站");
   println!("{}",z);
}
```
...
```sh
fn main(){
   let name1 = "你好，DDKK.COM 弟弟快看，程序员编程资料站
   DDKK.COM 弟弟快看，程序员编程资料站".to_string();
   println!("{}",name1);
}
```
...
下面的代码，我们搜索字符串中所有的 **程** 字，并替换成 www.ddkk.com

```sh
fn main(){
   let name1 = "DDKK.COM 弟弟快看，程序员编程资料站 简单编
   程".to_string(); //原字符串对象
   let name2 = name1.replace("程","www.ddkk.com");    // 查找并替换
   println!("{}",name2);
}
```
...
```sh
let name1 = "DDKK.COM 弟弟快看，程序员编程资料站"; 
```

name1 是一个字符串字面量，它只包含 DDKK.COM 弟弟快看，程序员编程资料站 四个字本身。
...
```sh
fn main() {
   let example_string = String::from("DDKK.COM 弟弟快看，程序员编程资料站");
...
```sh
显示的字符串字面量是: DDKK.COM 弟弟快看，程序员编程资料站
```
...
```sh
fn main(){
   let mut company = "DDKK.COM 弟弟快看，程序员编程资料站".to_string();
   company.push('t');
   println!("{}",company);
}
```
...
fn main(){
   let mut company = "DDKK.COM 弟弟快看，程序员编程资料站".to_string();
   company.push_str(" DDKK.COM 弟弟快看，程序员编程资料站");
   println!("{}",company);
}
```
...
```sh
fn main() {
   let fullname = " DDKK.COM 弟弟快看，程序员编程资料站 DDKK.COM 弟弟快看，程序员编程资料站 www.ddkk.com";
...
```sh
fn main(){
   let msg = "DDKK.COM 弟弟快看，程序员编程资料站 DDKK.COM 弟弟快看，程序员编程资料站 www.ddkk.com
   https://www.ddkk.com".to_string();
   let mut i = 1;
...
```sh
token 1 DDKK.COM 弟弟快看，程序员编程资料站
token 2 DDKK.COM 弟弟快看，程序员编程资料站
token 3 www.ddkk.com
token 4 https://www.ddkk.com
```
...
```sh
fn main(){
   let n1 = "DDKK.COM 弟弟快看，程序员编程资料站 www.ddkk.com".to_string();
   for n in n1.chars(){
      println!("{}",n);
   }
}
...
```sh
fn main(){
   let n1 = "DDKK.COM 弟弟快看，程序员编程资料站".to_string();
   let n2 = "DDKK.COM 弟弟快看，程序员编程资料站".to_string();
