# 28、Rust IO 输入输出
- 来源：https://ddkk.com/zhuanlan/other/rust/28.html
- 分类：Rust 教程
- 分组：教程目录
...
Write
包含了许多方法用于向输出流中写入数据，包含字节数据和 UTF-8 数据两种格式
Stdout,File
...
从输入流中读取一行的字符串数据并存储在 line 参数中。返回 Result 枚举，如果成功则返回读取的字节数。
