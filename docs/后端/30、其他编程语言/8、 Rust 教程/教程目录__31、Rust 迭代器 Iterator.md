# 31、Rust 迭代器 Iterator
- 来源：https://ddkk.com/zhuanlan/other/rust/31.html
- 分类：Rust 教程
- 分组：教程目录
**迭代器** 主要用来 **遍历** 集合。
...
有了for ... in 语句，我们遍历结合就比较轻松了，短短三行代码就搞定了。
...
```sh
fn main() {
   let names = vec!["DDKK.COM 弟弟快看，程序员编程资料站", "简明教程", "DDKK.COM 弟弟快看，程序员编程资料站"];
...
我们当中有一个异类!
Hello DDKK.COM 弟弟快看，程序员编程资料站
["DDKK.COM 弟弟快看，程序员编程资料站", "简明教程", "DDKK.COM 弟弟快看，程序员编程资料站"]
```
...
集合的iter() 方法返回的是一个只读迭代，我们不能通过迭代器来修改集合。
...
```sh
fn main() {
   let mut names = vec!["DDKK.COM 弟弟快看，程序员编程资料站", "简明教程", "DDKK.COM 弟弟快看，程序员编程资料站"];
   for name in names.iter_mut() {
      match name {
         &mut "简明教程" => { *name = "DDKK.COM 弟弟快看，程序员编程资料站";println!("我们中间有一个异类!")},
         _ => println!("Hello {}", name),
      }
   }
   // 集合还可以重复使用
...
我们中间有一个异类!
Hello DDKK.COM 弟弟快看，程序员编程资料站
["DDKK.COM 弟弟快看，程序员编程资料站", "DDKK.COM 弟弟快看，程序员编程资料站", "DDKK.COM 弟弟快看，程序员编程资料站"]
```
