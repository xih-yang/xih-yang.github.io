...
- 来源：https://ddkk.com/zhuanlan/java/jvm/7/25.html
- 分类：JVM 实战
- 分组：教程目录
### 1、概述
...
-flag [±]name
开启或者关闭对应名称的参数，只有被标为manageable的参数才可以被动态修改
...
-heap
输出整个堆空间的统计信息，包括GC的使用、堆配置信息，以及内存的使用信息等

-histo
输出堆空间中的对象的统计信息，包括类、实例数量和合计容量
