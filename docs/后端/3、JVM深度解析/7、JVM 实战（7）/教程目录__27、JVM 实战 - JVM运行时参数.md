# 27、JVM 实战 - JVM运行时参数
- 来源：https://ddkk.com/zhuanlan/java/jvm/7/27.html
- 分类：JVM 实战
- 分组：教程目录
### 1、JVM参数选项类型
...
Java提供了java.lang.management包用于监视和管理Java虚拟机和Java运行时中的其他组件，它允许本地和远程监控和管理运行Java虚拟机。其中**ManagementFactory**这个类还是挺常用的。另外还有**Runtime**类也可以获取一些内存、CPU核数等相关数据。
