...
- 来源：https://ddkk.com/zhuanlan/design/javascript/25.html
- 分类：设计模式
- 分组：教程目录
...
**1、** 男生会考虑女生的长相、身高、性格、三观、家境、和自己父母能不能合得来、对方家长是否好相处等等；

**2、** 男生的家长会考虑女生的条件、和自己儿子搭不搭、对方家长的性格等等；

女方的角度：

**1、** 女生会考虑男生的性格、上进心、是不是高富帅、能不能通过自己父母的法眼、对方家长是否好相处等等；

**2、** 女生的家长也会考虑男生的条件、是不是配得上自己女儿、对方家长的性格等等；
...
类似的例子还有很多，比如电商平台的买家与店家，聊天平台与每个聊天者，澳门大型线上赌场与每个参与赌博的人….?
...
**2、** 当出现中介者可维护性变差的情况时，考虑是否在系统设计上不合理，从而简化系统设计，优化并重构，避免中介者出现职责过重的情况；
...
**1、** 中介者模式将多个平等对象之间内部的复杂交互关系封装起来，主要目的是为了多个对象之间的解耦；

**2、** 外观模式封装一个子系统内部的模块，是为了向系统外部提供方便的调用；
