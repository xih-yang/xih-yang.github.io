...
- 来源：https://ddkk.com/zhuanlan/design/java/6.html
- 分类：设计模式
- 分组：教程目录
...
```java
$ javac -d . src/main/com.ddkk/gof/AbstractFactoryPatternDemo.java
$ java  com.ddkk.gof.AbstractFactoryPatternDemo
