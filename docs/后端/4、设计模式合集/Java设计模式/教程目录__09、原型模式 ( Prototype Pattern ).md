...
- 来源：https://ddkk.com/zhuanlan/design/java/9.html
- 分类：设计模式
- 分组：教程目录
...
**2、** 定义类*ShapeCache*，该类把shape对象存储在一个*Hashtable*中，并在请求的时候返回它们的克隆；
...
```java
$ javac -d . src/main/com.ddkk/gof/PrototypePatternDemo.java
$ java  com.ddkk.gof.PrototypePatternDemo
Shape : Circle
Shape : Square
Shape : Rectangle
```
