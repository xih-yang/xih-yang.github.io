# 30、MVC 模式
- 来源：https://ddkk.com/zhuanlan/design/java/30.html
- 分类：设计模式
- 分组：教程目录
...
**4、** 最后类*MVCPatternDemo*使用*StudentController*来演示MVC模式的用法；
...
```java
$ javac -d . src/main/com.ddkk/gof/MVCPatternDemo.java
$ java  com.ddkk.gof.MVCPatternDemo
Student: 
Name: Robert
Roll No: 10
Student: 
