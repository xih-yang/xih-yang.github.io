...
- 来源：https://ddkk.com/zhuanlan/design/java/32.html
- 分类：设计模式
- 分组：教程目录
...
```java
$ javac -d . src/main/com.ddkk/gof/CompositeEntityPatternDemo.java
$ java  com.ddkk.gof.CompositeEntityPatternDemo
Data: Test
Data: Data
Data: Second Test
Data: Data1
