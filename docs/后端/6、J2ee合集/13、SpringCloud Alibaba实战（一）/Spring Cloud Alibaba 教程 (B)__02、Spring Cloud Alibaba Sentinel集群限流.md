...
- 来源：https://ddkk.com/zhuanlan/j2ee/springcloudalibaba/1/28.html
- 分类：J2EE框架
...
其中mode 为 `0` 代表 client，`1` 代表 server，`-1` 代表关闭。

**PS：注意应用端需要引入集群限流客户端或服务端的相应依赖。**

## 4. 如何使用

请前往[Sentinel 整合 SpringCloudAlibaba实现流量控制、熔断降级、热点参数限流、系统自我保护、网关流量控制等规则配置(详细图文描述)](/zhuanlan/guarantee/sentinel/31.html) 查看具体步骤
