# 11.2 集成测试的目标
- 来源：https://ddkk.com/zhuanlan/j2ee/spring/1/44.html
- 分类：J2EE框架
- 分组：11. 单元测试
...
如果你需要提交事务——通常不会这样做，但有时当你想用一个特定的测试来填充或者修改数据库时也会显得有用——TestContext框架将根据[@Commit](https://github.com/Commit)注解的指示对事务进行提交而不是回滚。
