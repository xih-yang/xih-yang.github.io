# 11.3 JDBC测试支持
- 来源：https://ddkk.com/zhuanlan/j2ee/spring/1/45.html
- 分类：J2EE框架
- 分组：11. 单元测试
...
注意[AbstractTransactionalJUnit4SpringContextTests](http://docs.spring.io/spring/docs/5.0.0.BUILD-SNAPSHOT/spring-framework-reference/htmlsingle/#testcontext-support-classes-junit4)*和*[AbstractTransactionalTestNGSpringContextTests](http://docs.spring.io/spring/docs/5.0.0.BUILD-SNAPSHOT/spring-framework-reference/htmlsingle/#testcontext-support-classes-testng)提供了委托给前面所述的JdbcTestUtils中的方法的简便方法。
