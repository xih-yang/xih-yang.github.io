# 19.5 JSP &amp; JSTL
- 来源：https://ddkk.com/zhuanlan/j2ee/spring/1/77.html
- 分类：J2EE框架
- 分组：19. 视图技术
...
标签库描述符（TLD）包含在spring-webmvc.jar中。
...
相应的[@Controller](https://github.com/Controller)方法如下所示：
