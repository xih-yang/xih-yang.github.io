# 27.5 JSR-160连接器
- 来源：https://ddkk.com/zhuanlan/j2ee/spring/1/109.html
- 分类：J2EE框架
- 分组：27. JMS
...
ConnectorServerFactoryBean创建的JMXConnectorServer默认会绑定到”servicejmxmp://localhost:9875”.serverConnector通过JMXMP协议在本地的9875端口上将本地的MBeanServer暴露给客户端。注意，JMXMP协议是JSR 160标记为可选协议：当前 ，JMX主要的开源实现MX4J，它只提供了基于JDK的协议，而不支持JMXMP。
