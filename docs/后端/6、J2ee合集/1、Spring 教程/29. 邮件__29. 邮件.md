# 29. 邮件
- 来源：https://ddkk.com/zhuanlan/j2ee/spring/1/113.html
- 分类：J2EE框架
- 分组：29. 邮件
## 29.1 介绍
...
org.springframework.mail.javamail.JavaMailSender接口继承自MailSender接口，并增加了一些特有的JavaMail功能，如*MIME*邮件的支持。JavaMailSender还提供了一个用于编写*MIME*消息的回调org.springframework.mail.javamail.MimeMessagePreparator接口。
...
### 29.2.1MailSender和SimpleMailMessage的基本用法
