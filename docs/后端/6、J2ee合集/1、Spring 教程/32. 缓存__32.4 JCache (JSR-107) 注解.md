...
- 来源：https://ddkk.com/zhuanlan/j2ee/spring/1/118.html
- 分类：J2EE框架
- 分组：32. 缓存
...
键由javax.cache.annotation.CacheKeyGenerator 生成，和 Spring 的 KeyGenerator 能达到相同的目标。默认情况下，所有方法参数都会被考虑，除非至少有一个参数被注解为 [@CacheKey](https://github.com/CacheKey)。这和 Spring 的自定义键生成类似。例如，下面代码操作是相同的，一个使用 Spring 抽象，另一个使用 JCache：
