# 33. Spring框架的新功能
- 来源：https://ddkk.com/zhuanlan/j2ee/spring/1/123.html
- 分类：J2EE框架
- 分组：33. Spring框架的新功能
...
[Spring 5.x框架新的功能](https://github.com/spring-projects/spring-framework/wiki/What)

[Spring 4.x框架新的功能](https://github.com/spring-projects/spring-framework/wiki/What)

[Spring 3.x框架新的功能](https://github.com/spring-projects/spring-framework/wiki/What)
...
- 支持[@Nullable](https://github.com/Nullable)注解
...
- 多个不可变对象的数据绑定(Kotlin/Lombok/[@ConstructorPorties](https://github.com/ConstructorPorties))
- 支持jackson2.9
- 支持JSON绑定API
- 支持protobuf3
...
- SpringExtension:是JUnit多个可拓展API的一个实现，提供了对现存Spring TestContext Framework的支持，使用[@ExtendWith](https://github.com/ExtendWith)(SpringExtension.class)注解引用。
- [@SpringJunitConfig](https://github.com/SpringJunitConfig):一个复合注解
- [@ExtendWith](https://github.com/ExtendWith)(SpringExtension.class) 来源于Junit Jupit
- [@ContextConfiguration](https://github.com/ContextConfiguration) 来源于Srping TestContext框架
- [@DisabledIf](https://github.com/DisabledIf) 如果提供的该属性值为true的表达或占位符，信号：注解的测试类或测试方法被禁用
