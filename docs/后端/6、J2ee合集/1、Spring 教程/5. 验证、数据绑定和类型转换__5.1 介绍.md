# 5.1 介绍
- 来源：https://ddkk.com/zhuanlan/j2ee/spring/1/25.html
- 分类：J2EE框架
- 分组：5. 验证、数据绑定和类型转换
...
正如[5.8.3 配置DataBinder](http://ifeve.com/spring-5-validation/#5.8.3%20Configuring%20a%20DataBinder)所述，应用程序也可以为每个DataBinder实例注册额外的SpringValidator实例，这可能有助于不通过使用注解而插入验证逻辑。
