...
- 来源：https://ddkk.com/zhuanlan/j2ee/spring/1/26.html
- 分类：J2EE框架
- 分组：5. 验证、数据绑定和类型转换
...
验证错误被报告给传递到验证器的Errors对象。在使用Spring Web MVC的情况下，你可以使用``标签来检查错误信息，不过当然你也可以自己检查错误对象。有关它提供的方法的更多信息可以在java文档中找到。
