# 处理表单中的文件上传
- 来源：https://ddkk.com/zhuanlan/j2ee/springmvc/1/40.html
- 分类：J2EE框架
...
下一步是创建一个能处理文件上传的控制器。这里需要的控制器与[一般注解了@Controller的控制器](http://docs.spring.io/spring-framework/docs/4.2.4.RELEASE/spring-framework-reference/html/mvc.html#mvc-ann-controller)基本一样，除了它接受的方法参数类型是MultipartHttpServletRequest，或MultipartFile。
