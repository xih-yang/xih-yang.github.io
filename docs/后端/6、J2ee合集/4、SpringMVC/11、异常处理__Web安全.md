# Web安全
- 来源：https://ddkk.com/zhuanlan/j2ee/springmvc/1/48.html
- 分类：J2EE框架
- 分组：11、异常处理
...
MVC集成”](http://docs.spring.io/spring-security/site/docs/current/reference/htmlsingle/#mvc)。不过并非应用的所有特性都需要引入Spring Security。比如，需要CSRF保护的话，你仅需要简单地在配置中添加一个过滤器CsrfFilter和处理器CsrfRequestDataValueProcessor。你可以参考[Spring MVC Showcase](https://github.com/spring-projects/spring-mvc-showcase/commit/361adc124c05a8187b84f25e8a57550bb7d9f8e4)一节，观看一个完整的展示。
