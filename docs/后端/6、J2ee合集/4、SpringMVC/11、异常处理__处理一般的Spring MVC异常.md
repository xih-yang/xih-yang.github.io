# 处理一般的Spring MVC异常
- 来源：https://ddkk.com/zhuanlan/j2ee/springmvc/1/45.html
- 分类：J2EE框架
- 分组：11、异常处理
...
TheDefaultHandlerExceptionResolver works transparently by setting the

status of the response. However, it stops short of writing any error content

tothe body of the response while your application may need to add developer-
...
Ifyou prefer to write error content via @ExceptionHandler methods you can
