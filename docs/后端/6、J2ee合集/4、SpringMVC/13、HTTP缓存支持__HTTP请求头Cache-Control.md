...
- 来源：https://ddkk.com/zhuanlan/j2ee/springmvc/1/54.html
- 分类：J2EE框架
- 分组：13、HTTP缓存支持
...
[CacheControl](http://docs.spring.io/spring-framework/docs/4.2.4.RELEASE/javadoc-api/org/springframework/http/CacheControl.html)构造器类被简单的用来描述”Cache-Control”缓存控制指令，使你能更容易地创建自己的HTTP缓存策略。创建完了以后，CacheControl类的实例就可以在Spring MVC的许多API中被传入为方法参数了。
