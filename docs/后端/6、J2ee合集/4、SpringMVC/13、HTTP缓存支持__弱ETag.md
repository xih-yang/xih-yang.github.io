# 弱ETag
- 来源：https://ddkk.com/zhuanlan/j2ee/springmvc/1/57.html
- 分类：J2EE框架
- 分组：13、HTTP缓存支持
...
更多配置细节，请参考第[21.15 基于代码的Servlet容器初始化](http://docs.spring.io/spring-framework/docs/4.2.4.RELEASE/spring-framework-reference/html/mvc.html#mvc-container-config)一小节。
