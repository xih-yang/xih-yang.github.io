# Spring Web MVC的新特性
- 来源：https://ddkk.com/zhuanlan/j2ee/springmvc/1/3.html
- 分类：J2EE框架
...
- 新增生命周期仅绑定到当前HTTP请求或HTTP会话的Bean类型。严格来说，这不是Spring MVC自身的特性，而是Spring MVC使用的上下文容器WebApplicationContext所提供的特性。这些bean的scope在[6.5.4 请求、会话及全局会话scope](http://docs.spring.io/spring-framework/docs/4.2.4.RELEASE/spring-framework-reference/html/beans.html#beans-factory-scopes-other)一节有详细描述。
