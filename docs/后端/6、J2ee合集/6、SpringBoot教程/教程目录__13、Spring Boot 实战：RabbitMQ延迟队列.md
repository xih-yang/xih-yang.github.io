...
- 来源：https://ddkk.com/zhuanlan/j2ee/springboot/8/13.html
- 分类：J2EE框架
- 分组：教程目录
...
RabbitMQ队列本身是没有直接实现支持延迟队列的功能，但可以通过它的[Time-To-Live Extensions](https://www.rabbitmq.com/ttl.html) 与 [Dead Letter Exchange](http://www.rabbitmq.com/dlx.html) 的特性模拟出延迟队列的功能。
...
public class BookController {
    ...
    /**
     * this.rabbitTemplate.convertAndSend(RabbitConfig.REGISTER_DELAY_EXCHANGE, RabbitConfig.DELAY_ROUTING_KEY, book); 对应 {@LinkBookHandler#listenerDelayQueue}
     */
    @GetMapping
...
完成准备事项后，启动Chapter12Application 访问 [http://localhost:8080/books](http://localhost:8080/books) 将会看到如下内容，就代表一切正常….

```java
2021-05-23 19:56:36.248  INFO 29048 --- [nio-8080-exec-1] com.battcn.controller.BookController     : [发送时间] - [2021-05-23T19:56:36.248]
2021-05-23 19:56:41.256  INFO 29048 --- [cTaskExecutor-1] com.battcn.handler.BookHandler           : [listenerDelayQueue 监听的消息] - [消费时间] - [2021-05-23T19:56:41.256] - [Book{id='1', name='一起来学Spring Boot'}]
```
...
全文代码：[https://github.com/battcn/spring-boot2-learning/tree/master/chapter12](https://github.com/battcn/spring-boot2-learning/tree/master/chapter12)
