...
- 来源：https://ddkk.com/zhuanlan/j2ee/springboot/5/6.html
- 分类：J2EE框架
- 分组：教程目录
## 一、AOP的简单介绍
...
[https://gitee.com/acgkaka/SpringBootExamples/tree/master/springboot-aop](https://gitee.com/acgkaka/SpringBootExamples/tree/master/springboot-aop)

## 三、补充知识

### 1.AOP的底层原理是动态代理，对实例进行增强；

### 2.AOP不对static修饰的方法生效。
