...
- 来源：https://ddkk.com/zhuanlan/j2ee/springboot/5/9.html
- 分类：J2EE框架
- 分组：教程目录
## 1. 简介
...
- 在 WebSocket API 中，浏览器和服务器只需一次握手，就可以创建持久性的连接，并进行双向数据传输。
...
<div class="row">
    <div id="output" style="border:1px solidccc;height:365px;overflow: auto;margin: 20px 0;"></div>
