...
- 来源：https://ddkk.com/zhuanlan/j2ee/springboot/7/6.html
...
当然任何模式都需要首先引入`mybatis-spring-boot-starter`的 Pom 文件，现在最新版本是 3.0.0
...
源码中Controller 层有完整的增删改查，这里就不贴了

### 极简 xml 版本

极简xml 版本保持映射文件的老传统，接口层只需要定义空方法，系统会自动根据方法名在映射文件中找对应的 Sql .
