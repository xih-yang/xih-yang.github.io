...
- 来源：https://ddkk.com/zhuanlan/j2ee/springboot/7/11.html
...
pom包里面添加 `spring-boot-starter-data-mongodb` 包引用
...
到此Spring Boot 对应 MongoDB 的增删改查功能已经全部实现。
...
继承了MongoRepository 会默认实现很多基本的增删改查，省了很多自己写 Repository 层的代码
