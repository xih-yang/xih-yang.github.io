...
- 来源：https://ddkk.com/zhuanlan/j2ee/springboot/7/22.html
...
配置了h2 数据库，已经项目的日志级别。配置 schema 和 data 后，项目启动时会根据配置的文件地址来执行数据。

#### 业务代码

创建MybatisPlusConfig 类，指定 Mapper 地址，启用分页功能。
...
创建MyBatisPlusTest 类，注入上面创建的 UserMapper 类。
