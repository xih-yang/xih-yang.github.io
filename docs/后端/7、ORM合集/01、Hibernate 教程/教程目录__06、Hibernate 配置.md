# 06、Hibernate 配置
- 来源：https://ddkk.com/zhuanlan/orm/hibernate/6.html
- 分类：ORM框架
- 分组：教程目录
## 配置
...
XML配置文件一定要遵守 Hibernate 3 Configuration DTD，在 [http://www.hibernate.org/dtd/hibernate-configuration-3.0.dtd](http://www.hibernate.org/dtd/hibernate-configuration-3.0.dtd). 这个网址中是可以找到的。
