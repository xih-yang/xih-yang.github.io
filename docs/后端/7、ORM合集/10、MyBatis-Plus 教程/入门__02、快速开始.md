# 02、快速开始
- 来源：https://ddkk.com/zhuanlan/orm/mybatisplus/1/2.html
- 分类：ORM框架
- 分组：入门
...
在Spring Boot 启动类中添加 `@MapperScan` 注解，扫描 Mapper 文件夹：
...
但MyBatis-Plus 的强大远不止这些功能，想要详细了解 MyBatis-Plus 的强大功能？那就继续往下看吧！
