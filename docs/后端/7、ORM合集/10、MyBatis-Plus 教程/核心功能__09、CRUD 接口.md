# 09、CRUD 接口
- 来源：https://ddkk.com/zhuanlan/orm/mybatisplus/1/9.html
- 分类：ORM框架
- 分组：核心功能
## Service CRUD 接口
...
选装件位于 `com.baomidou.mybatisplus.extension.injector.methods` 包下 需要配合Sql 注入器使用,[案例(opens new window)](https://gitee.com/baomidou/mybatis-plus-samples/tree/master/mybatis-plus-sample-sql-injector)
