# 15、定义一个页面
- 来源：https://ddkk.com/zhuanlan/qianduan/vuejs/15.html
- 分类：前端框架
- 分组：Webpack + Vuejs实战
...
- ``代码块中,表示的是 HTML模板. 里面写的就是最普通的HTML 。
- ``表示的是 js 代码. 所有的js代码都写在这里. 这里使用的是 EM Script.
- ``表示所有的 CSS/SCSS/SASS 文件都可以写在这里.

现在,我们可以直接访问 [http://localhost:8080/#/say_hi](http://localhost:8080/#/say_hi) 这个链接了. 打开后，页面如下图所示：
