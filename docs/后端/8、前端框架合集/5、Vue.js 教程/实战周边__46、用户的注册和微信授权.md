# 46、用户的注册和微信授权
- 来源：https://ddkk.com/zhuanlan/qianduan/vuejs/46.html
- 分类：前端框架
- 分组：实战周边
...
**1、** 4.1增加`src/vuex/store.js`.这个是最最核心的文件完整如下所示：
...
**1、** 4.2增加`vuex/modules/user_info.js`这个文件：
...
**1、** 4.3增加`src/vuex/mutation_types.js`；
...
**1、** 4.4增加`src/vuex/modules/actions.js`；
...
**1、** 4.5增加`src/vuex/modules/getters.js`；
...
[http://shopweb.siwei.me/auth/wechat](http://shopweb.siwei.me/auth/wechat)
...
- 第一次跳转到 [http://shopweb.siwei.me/auth/wechat](http://shopweb.siwei.me/auth/wechat)
- 第二次跳转到 [https://open.weixin.qq.com/connect/oauth2/authorize](https://open.weixin.qq.com/connect/oauth2/authorize)
