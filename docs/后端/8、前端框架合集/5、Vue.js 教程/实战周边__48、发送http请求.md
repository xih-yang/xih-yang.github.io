# 48、发送http请求
- 来源：https://ddkk.com/zhuanlan/qianduan/vuejs/48.html
- 分类：前端框架
- 分组：实战周边
...
我们新增一个页面,叫 “博客列表页” : `src/components/BlogList.vue`, 它的作用是从我的个人网站([http://siwei.me](http://siwei.me)) 上，读取文章的标题，并且显示出来。
...
[http://siwei.me/interface/blogs/all](http://siwei.me/interface/blogs/all)
...
**1、** 对于所有以“/api”　开头的url做处理．；

**2、** 把url中的　“/api”去掉．；

**3、** 把新的url请求打到　siwei.me上．；
...
关于发送http请求的更多内容，请看： 官方文档：[https://github.com/pagekit/vue-resource](https://github.com/pagekit/vue-resource)
