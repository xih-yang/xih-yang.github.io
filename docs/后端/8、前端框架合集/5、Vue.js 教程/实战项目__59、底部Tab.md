# 59、底部Tab
- 来源：https://ddkk.com/zhuanlan/qianduan/vuejs/59.html
- 分类：前端框架
- 分组：实战项目
...
<template> 
  <div class="footer"> 
      <footer class="fixBottomBox"> 
        <ul> 
            <router-Linktag="li" to="/" class="tabItem"> 
            ...
            <router-Linktag="li" to="/shops/category" class="tabItem"> 
            ...
            <router-Linktag="li" to="/cart" class="tabItem"> 
            ...
            <router-Linktag="li" to="/mine" class="tabItem"> 
