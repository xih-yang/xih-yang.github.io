# 62、购物车
- 来源：https://ddkk.com/zhuanlan/qianduan/vuejs/62.html
- 分类：前端框架
- 分组：实战项目
购物车具备两个功能：
...
新增src/components/Car.vue 文件，内容如下：
...
**3、** 1新增购物车的头部文件src/components/CartHeader.vue:；
...
**3、** 2新增购物车的主体内容src/components/CartMain.vue:；
