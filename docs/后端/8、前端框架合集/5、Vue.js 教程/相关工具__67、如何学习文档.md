# 67、如何学习文档
- 来源：https://ddkk.com/zhuanlan/qianduan/vuejs/67.html
- 分类：前端框架
- 分组：相关工具
...
Vuejs中已经集成了这个工具， 我们在使用vue-cli的时候，就会根据命令来生成 `webpack`所要求的文件结构，然后在打包的时候(`npm run build`) ，vuejs的源代码就会被webpack打包成正常的html代码和文件目录。

这个内容我们以后会讲到。大家要知道在本书中所讲的知识，都是”基于webpack的vuejs” 。 否则光看vuejs的官方文档，是看不懂的。

## 官方文档地址

[https://cn.vuejs.org/](https://cn.vuejs.org/) (点击右上角的 translation就可以看到入口）
