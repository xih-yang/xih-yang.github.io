# 42、与CSS预处理器结合使用
- 来源：https://ddkk.com/zhuanlan/qianduan/vuejs/42.html
- 分类：前端框架
- 分组：进阶知识
...
CSS是唯一不具备 支持变量的 编程语言。 因为CSS 本身只是一个DSL（Domain Specific Language领域特定的语言）, 它不是一个“编程语言”。
...
全名叫Sassy CSS, （时髦的CSS） 是 SASS 3 引入新的语法，其语法完全兼容 CSS3，并且继承了 SASS 的强大功能。

也就是说，任何标准的 CSS3 样式表都是具有相同语义的有效的 SCSS 文件。

官方网站同 SASS。

由于SCSS 是 CSS 的扩展，因此，所有在 CSS 中正常工作的代码也能在 SCSS 中正常工作。 也就是说，对于一个 SASS 用户，只需要理解 SASS 扩展部分如何工作的，就能完全理解 SCSS。
...
更多内容，可以到官方网站来学习： [https://sass-lang.com/guide](https://sass-lang.com/guide) 非常简单，有一点儿CSS功底的人，往往可以瞬间上手。

## LESS

LESS 也是一种 CSS 预处理器，它的自我介绍是： 只是多了”一丢丢”内容的CSS. ( It’s CSS, with just a little more).

官方网址： [http://lesscss.org/](http://lesscss.org/) , Github: [https://github.com/less/less.js](https://github.com/less/less.js) ， 截止到 2018-6-25 , github关注数是 15591
...
官方网站： [https://sass-lang.com/](https://sass-lang.com/) , github: [https://github.com/sass/sass](https://github.com/sass/sass) , 截止到 2016-6-25, github关注数是 11376
