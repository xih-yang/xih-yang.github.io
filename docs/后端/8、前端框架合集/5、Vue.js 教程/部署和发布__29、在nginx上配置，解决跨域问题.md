# 29、在nginx上配置，解决跨域问题
- 来源：https://ddkk.com/zhuanlan/qianduan/vuejs/29.html
- 分类：前端框架
- 分组：部署和发布
...
1.使用浏览器打开页面: [http://vue_demo.siwei.me/#/blogs](http://vue_demo.siwei.me/#/blogs) , 页面出错。

**2、** 可以看到，出错的原因是404,打开“[http://vue_demo.siwei.me/api/interface/blogs/all](http://vue_demo.siwei.me/api/interface/blogs/all)“；
...
**2、** 在开发的时候,继续保持vuejs的代理存在.配置代码如下:（无变化）；
