...
- 来源：https://ddkk.com/zhuanlan/qianduan/nodejs/29.html
- 分类：前端框架
- 分组：教程目录
...
和 domain.bind(callback) 类似
除了捕捉被抛出的错误外，它还会拦截 Error 对象作为参数传递到这个函数
