...
- 来源：https://ddkk.com/zhuanlan/java/swing/4.html
- 分类：Swing 教程
- 分组：教程目录
...
如果 JLabel 同时显示图标和文本，则此属性定义它们之间的间隔

void setHorizontalTextPosition(int textPosition)
设置 JLabel 的文本相对其图像的水平位置
...
返回 JLabel 的文本相对其图像的水平位置

int getHorizontalAlignment()
返回 JLabel 沿 X 轴的对齐方式

**例1**

使用JFrame 组件创建一个窗口，然后向窗口中添加 3 个标签，这 3 个标签分别使用不同的创建方法。实现代码如下：
