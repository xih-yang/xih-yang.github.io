...
- 来源：https://ddkk.com/zhuanlan/java/swing/5.html
- 分类：Swing 教程
- 分组：教程目录
...
void setMnemonic(int nmemonic)
设置按钮的键盘快捷键，所设置的快捷键在际操作时需要结合Alt 键进行实现
...
void setRolloveiicon(Icon icon)
设置鼠标移动到按扭区域时的图标
...
使用JFrame 组件创建一个窗口，然后创建 4 个不同类型的按钮，再分别添加到窗口上显示。具体代码如下：
