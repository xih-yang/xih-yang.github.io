...
- 来源：https://ddkk.com/zhuanlan/java/swing/8.html
- 分类：Swing 教程
- 分组：教程目录
...
使用JFmme 组件创建一个窗口，然后使用 JCheckBox 类创建一些复选框。具体实现代码如下：
...
上述程序一共创建了 6 个复选框，其中第一个调用 JCheckBox 构造方法时指定了复选框为选中状态。程序的执行结果如图所示。
