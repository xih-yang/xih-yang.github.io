...
- 来源：https://ddkk.com/zhuanlan/java/swing/24.html
- 分类：Swing 教程
- 分组：教程目录
...
创建了JTabbedPane 实例之后，可使用 addTab() 方法和 insertTab() 方法将选项卡/组件添加到 TabbedPane 对象中。选项卡通过对应于添加位置的索引来表示，其中第一个选项卡的索引为 0，最后一个选项卡的索引为选项卡数量减 1。
...
使用JTabbedPane 类创建一个包含 4 个标签的选项卡面板，并分别为每个选项卡填充内容，主要实现过程如下。
