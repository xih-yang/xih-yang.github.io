# 13、JSP 表单处理
- 来源：https://ddkk.com/zhuanlan/java/jsp/13.html
- 分类：JSP 教程
- 分组：教程目录
## JSP 表单处理
...
将以上HTML代码保存到Hello.htm文件中。 将该文件放置于/webapps/ROOT 目录下。 通过访问 *http://localhost:8080/Hello.htm*，输出界面如下所示：
