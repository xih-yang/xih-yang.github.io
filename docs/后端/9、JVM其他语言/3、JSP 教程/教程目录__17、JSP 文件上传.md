# 17、JSP 文件上传
- 来源：https://ddkk.com/zhuanlan/java/jsp/17.html
- 分类：JSP 教程
- 分组：教程目录
...
- 以下实例依赖 FileUpload, 所以你需要在你的classpath中引入最新的 **commons-fileupload.x.x.jar** 包文件。 下载地址为：[http://commons.apache.org/fileupload/](http://commons.apache.org/fileupload/)。
- FileUpload 依赖 Commons IO, 所以你需要在你的classpath中引入最新的 **commons-io-x.x.jar** 。 下载地址为：[http://commons.apache.org/io/](http://commons.apache.org/io/)。
