# 27、JSP 自定义标签
- 来源：https://ddkk.com/zhuanlan/java/jsp/27.html
- 分类：JSP 教程
- 分组：教程目录
## JSP 自定义标签
...
编译以上类，并将其复制到环境变量CLASSPATH目录中。最后创建如下标签库：``webapps\ROOT\WEB-INF\custom.tld。
...
属性的名称是”message”，所以setter方法是的setMessage()。现在让我们在TLD文件中使用的 元素添加此属性：
