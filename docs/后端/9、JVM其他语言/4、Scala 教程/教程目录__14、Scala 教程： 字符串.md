# 14、Scala 教程： 字符串
- 来源：https://ddkk.com/zhuanlan/java/scala/14.html
- 分类：Scala 教程
- 分组：教程目录
...
```java
scala> "教程 官网： ".concat("ddkk.com");
res0: String = 教程 官网： ddkk.com
```

同样你也可以使用加号(+)来连接：

```java
scala> "教程 官网： " + " ddkk.com"
res1: String = 教程 官网：  ddkk.com
```
