...
- 来源：https://ddkk.com/zhuanlan/java/scala/17.html
- 分类：Scala 教程
- 分组：教程目录
...
object Test {
   def main(args: Array[String]) {
      val it = Iterator("百度", "腾讯", "DDKK.COM 弟弟快看，程序员编程资料站", "淘宝")
      while (it.hasNext){
         println(it.next())
      }
   }
...
def isTraversableAgain: BooleanTests
检查迭代器是否可以从头迭代
