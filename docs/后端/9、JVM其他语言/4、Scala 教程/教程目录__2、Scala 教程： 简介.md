# 2、Scala 教程： 简介
- 来源：https://ddkk.com/zhuanlan/java/scala/2.html
- 分类：Scala 教程
- 分组：教程目录
...
Odersky先前的工作是Generic Java和javac（Sun Java编译器）。Java平台的Scala于2003年底/2004年初。.NET平台的Scala于2004年6月。该语言第二个版本，v2.0，于2006年3月。
